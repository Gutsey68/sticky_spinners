<?php
	...
	class Custom_banner extends Module {

		public function __construct() {

			$this-> name = 'custom_banner';
			...
			$this-> displayName = $this-> l('Bannière custom');
			$this-> description = $this-> l('Bannière custom');
		}

		public function install () {
			if (!parent::install() || !$this->registerHook('displayHome') || !$this->registerHook('actionFrontControllerSetMedia')) {
				return false;
			}
			return true;
		}
